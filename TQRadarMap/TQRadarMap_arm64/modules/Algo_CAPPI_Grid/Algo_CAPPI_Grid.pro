...
contains(DEFINES, ALGORITHM_DEBUG){
    ...
    #DEFINES += ALGORITHM_DEBUG_CAPPI_GRID_S
    ...
    contains(DEFINES, ALGORITHM_DEBUG_CAPPI_GRID_S){
        INCLUDEPATH += \
                    $$PWD/../Library/LibAlgorithm/Lib_CAPPI_Mod   \

        HEADERS += \
                $$PWD/../Library/LibAlgorithm/Lib_CAPPI_Mod/lib_cappi_mod.h

        SOURCES += \
                $$PWD/../Library/LibAlgorithm/Lib_CAPPI_Mod/lib_cappi_mod.cpp
    }
}

# 项目名称
TARGET = Algo_CAPPI_Grid
