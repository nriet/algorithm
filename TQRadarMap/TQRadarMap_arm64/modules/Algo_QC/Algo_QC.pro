...
contains(DEFINES, ALGORITHM_DEBUG){
    ...
    contains(DEFINES, ALGORITHM_DEBUG_QC){
        INCLUDEPATH += \
                    $$PWD/../Library/LibAlgorithm/Lib_QC

        HEADERS += \
                $$PWD/../Library/LibAlgorithm/Lib_QC/lib_qc.h \

        SOURCES += \
                $$PWD/../Library/LibAlgorithm/Lib_QC/lib_qc.cpp \
    }
}
