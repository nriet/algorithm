...
from com.nriet.algorithm.common.drawComponent.drawController.DrawFrontController import DrawFrontController
...
class DrawFrontHandler(BaseHandler):
    """
    绘图服务处理类，暂不支持|方式命令
    """
    ...
    def doing(self,*args,**kwargs):
        ...
        try:
            ...
            draw_front_controller = DrawFrontController(request_dict=request_dict)
